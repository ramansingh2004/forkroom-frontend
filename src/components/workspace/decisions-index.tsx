    ...
    <div className={styles.page}>
      <div className={styles.pageHeader}>
        <div>
          ...
          <p>
            Find the decisions your team is shaping,
            voting on, or preserving.
          </p>
        </div>
      ...
      {decisions.data.length === 0 ? (
        <section className={styles.emptyState}>
          ...
          <p>
            Start with one question that deserves explicit
            alternatives, reasoning, and a traceable outcome.
          </p>
          ...
          {decisions.data.map((decision) => (
            ...
            >
              <div>
                ...
                <span>
                  {decision.summary || 'No summary yet'}
                </span>
              </div>
