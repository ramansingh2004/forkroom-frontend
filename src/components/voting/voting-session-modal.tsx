...
export function VotingSessionModal({
  ...
  const form =
    useForm<VotingSessionFormValues>({
      ...
      >
        <Stack gap="md">
          ...
          >
            ...
            <p>
              Create the round as a
              draft. Review submitted
              proposals and blocking
              objections before opening
              it to eligible members.
            </p>
          </div>
          ...
          {createSession.error && (
            <Alert
              color="red"
              title="Could not create voting round"
            >
              {getApiErrorMessage(
                createSession.error,
